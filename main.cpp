...
void ordenamientoDeLaListaDeKmRecorridos(float columnas[],int posiciones[], int dim,int tiposDeProdcutoPorCliente[],int& posCol, string tiposDeprod[]){	
	cout<<endl;
	float ax = 0;
	int ax2 = 0;
...
int main(){
	...
	int posCol{0};
	ordenamientoDeLaListaDeKmRecorridos(kmRocorridos,posiciones,tProd,tiposDeProdcutoPorCliente,posCol,tipoProd);
